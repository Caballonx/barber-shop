...
import { Calendar, Users, Scissors, DollarSign, Settings, LayoutDashboard, LogOut, CreditCard } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex text-white font-sans">
      ...
      <aside className="w-64 bg-[#111111] border-r border-[#22c55e]/20 hidden md:flex flex-col">
        ...
        <div className="p-4 border-t border-[#22c55e]/20">
          <button className="flex items-center gap-3 px-3 py-2.5 w-full rounded-md text-red-400 hover:bg-red-400/10 transition-colors">
